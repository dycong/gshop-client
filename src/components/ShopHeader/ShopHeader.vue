<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="showSupport=true">
      ...
      <div class="shop-brief-modal" v-show="showBulletin">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="showBulletin=false"></span>
          </div>
        </div>
        ...
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item activity-green" v-for="(support, index) in info.supports"
                :class="supportClasses[support.type]" :key="index">
            <span class="content-tag">
